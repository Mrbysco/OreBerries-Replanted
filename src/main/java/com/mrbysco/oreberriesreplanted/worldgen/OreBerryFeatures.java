...
public class OreBerryFeatures {
	...
	public static final Holder<PlacedFeature> IRON_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "iron_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> GOLD_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "gold_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> COPPER_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "copper_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> TIN_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "tin_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> ALUMINUM_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "aluminum_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> LEAD_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "lead_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> NICKEL_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "nickel_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> URANIUM_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "uranium_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> OSMIUM_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "osmium_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> ZINC_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "zinc_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> SILVER_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "silver_oreberry_bush").toString(),
	...
	public static final Holder<PlacedFeature> ESSENCE_OREBERRY_BUSH_PLACED_FEATURE = PlacementUtils.register(new ResourceLocation(Reference.MOD_ID, "essence_oreberry_bush").toString(),
