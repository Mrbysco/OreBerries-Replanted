...
public class OreBerryFeatures {
	public static final ConfiguredFeature<?, ?> IRON_OREBERRY_BUSH_FEATURE =
			register("iron_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.IRON_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 12)));
	...
	public static final ConfiguredFeature<?, ?> GOLD_OREBERRY_BUSH_FEATURE =
			register("gold_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.GOLD_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 6)));
	...
	public static final ConfiguredFeature<?, ?> COPPER_OREBERRY_BUSH_FEATURE =
			register("copper_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.COPPER_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 12)));
	...
	public static final ConfiguredFeature<?, ?> TIN_OREBERRY_BUSH_FEATURE =
			register("tin_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.TIN_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 12)));
	...
	public static final ConfiguredFeature<?, ?> ALUMINUM_OREBERRY_BUSH_FEATURE =
			register("aluminum_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.ALUMINUM_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 14)));
	...
	public static final ConfiguredFeature<?, ?> LEAD_OREBERRY_BUSH_FEATURE =
			register("lead_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.LEAD_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 14)));
	...
	public static final ConfiguredFeature<?, ?> NICKEL_OREBERRY_BUSH_FEATURE =
			register("nickel_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.NICKEL_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 12)));
	...
	public static final ConfiguredFeature<?, ?> URANIUM_OREBERRY_BUSH_FEATURE =
			register("uranium_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.URANIUM_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 14)));
	...
	public static final ConfiguredFeature<?, ?> OSMIUM_OREBERRY_BUSH_FEATURE =
			register("osmium_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.OSMIUM_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 13)));
	...
	public static final ConfiguredFeature<?, ?> ZINC_OREBERRY_BUSH_FEATURE =
			register("zinc_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.ZINC_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 12)));
	...
	public static final ConfiguredFeature<?, ?> SILVER_OREBERRY_BUSH_FEATURE =
			register("silver_oreberry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.SILVER_OREBERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 14)));
	...
	public static final ConfiguredFeature<?, ?> ESSENCE_BERRY_BUSH_FEATURE =
			register("essence_berry_bush", OreBerryRegistry.OREBERRY_FEATURE_CONFIG.get()
					.configured(new OreBerryBushFeatureConfig(OreFeatures.NATURAL_STONE, OreBerryRegistry.ESSENCE_BERRY_BUSH.get().defaultBlockState().setValue(OreBerryBushBlock.AGE, 3), 8)));
